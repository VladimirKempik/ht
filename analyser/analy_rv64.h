...
#define ANALY_RV_32 0
#define ANALY_RV_64 1

class AnalyRV64Disassembler: public AnalyDisassembler {
	int mode;
public:
        AnalyRV64Disassembler() {};
        AnalyRV64Disassembler(BuildCtorArg&a): AnalyDisassembler(a) {};
